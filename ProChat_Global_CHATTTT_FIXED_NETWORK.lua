-- Pro Chat Global - Network Restored / No Rooms / Session Settings
...
local API_KEY_FULL = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inl1d25ocGJ3cmRmY3Bqb25mb2RyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODczMzU2NDIsImV4cCI6MjEwMjkxMTY0Mn0.Ac99nEIxqgwVxWS1Q4527uhUqL_YgIDtH4ucZnzeSOc"
...
resetBtn.MouseButton1Click:Connect(function()
    settings.visibleMessages=defaultVisible; settings.width=0.39; settings.height=isTouch and 0.42 or 0.36
    ...
    task.spawn(function()
        while task.wait(POLL_INTERVAL) do
            pcall(function()
                ...
                local res=request({Url=url,Method="GET",Headers={apikey=API_KEY}})
