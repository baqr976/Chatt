...
-- Authoritative Chat button interaction.
-- Uses Activated so mouse, touch and gamepad activation all reach the same toggle.
local function activateChatButton()
    if editButtonMode then return end
    toggleChatWindow()
end

toggleBtn.Activated:Connect(activateChatButton)
if toggleHit then
    toggleHit.Activated:Connect(activateChatButton)
end
